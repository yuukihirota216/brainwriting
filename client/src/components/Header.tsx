  ...
  return (
    <header className="mb-8 text-center">
      <div className="flex items-center justify-center mb-2">
        ...
        <h1 className="text-2xl font-bold text-slate-800">Six Thinking Hats AI</h1>
      </div>
      <p className="text-slate-600 max-w-xl mx-auto">
        Analyze your text through the lens of the Six Thinking Hats methodology: different perspectives for comprehensive thinking.
      </p>
    </header>
  );
}
